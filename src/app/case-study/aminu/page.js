...
export default function AminuCaseStudy() {
  ...
  return (
    <div className="min-h-screen bg-[#030303] text-white font-sans">
      ...
      {/* ── Nav ─────────────────────────────────────────────────────────── */}
      <nav className="fixed top-0 left-0 w-full z-50 flex items-center justify-between px-8 md:px-14 py-6 bg-[#030303]/85 backdrop-blur-md border-b border-neutral-900/60">
        <Link href="/" className="font-bold text-[13px] tracking-[0.18em] text-white hover:opacity-60 transition-opacity">
          ALTTRED NEXXUS
        </Link>
        <Link
          href="/#projects"
          className="flex items-center gap-2 text-[11px] tracking-[0.22em] font-bold uppercase text-neutral-400 hover:text-white transition-colors"
        >
      ...
      >
        ...
        <div className="relative z-10 px-8 md:px-14 pb-14 md:pb-20 w-full">
          ...
          >
            ...
            <span className="text-[9px] tracking-[0.3em] uppercase font-bold text-neutral-500">
              01 — AMINU
            </span>
          </motion.div>
          ...
          >
            {TAGS.map((t) => (
              <span
                key={t}
                className="text-[9px] tracking-[0.15em] font-bold uppercase px-3 py-1.5 border border-neutral-800 text-neutral-400 rounded-full"
              >
                {t}
              </span>
            ))}
      ...
      {/* ── Score Banner ─────────────────────────────────────────────────── */}
      <section className="px-8 md:px-14 py-14 md:py-20 border-b border-neutral-900">
        <FadeUp className="mb-10">
          <p className="text-[9px] tracking-[0.4em] uppercase font-bold text-[#ff6b3d] mb-3">GTmetrix Performance Score</p>
          <h2 className="font-extrabold text-2xl md:text-3xl tracking-tight uppercase">The Result, At A Glance</h2>
        </FadeUp>

        <FadeUp delay={0.1}>
          <div className="grid md:grid-cols-[1fr_auto_1fr] gap-0 border border-neutral-800 overflow-hidden">
            {/* Before */}
            <div className="p-8 md:p-10 bg-[#1a0000] border-b md:border-b-0 md:border-r border-neutral-800">
              <p className="text-[9px] tracking-[0.4em] uppercase font-bold text-red-400 mb-5">Before</p>
              <p className="font-extrabold text-[80px] md:text-[100px] leading-none tracking-[-0.05em] text-red-400">D</p>
              <p className="font-bold text-2xl text-red-400/70 mt-1 mb-3">60%</p>
              <p className="text-[10px] tracking-[0.2em] uppercase text-neutral-600">GTmetrix performance score</p>
            </div>

            {/* Arrow */}
            <div className="hidden md:flex items-center justify-center px-8 bg-neutral-950 border-r border-neutral-800">
            ...
            <div className="flex md:hidden items-center justify-center py-5 bg-neutral-950 border-b border-neutral-800">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-neutral-600 rotate-90">
                <path d="M5 12h14M13 6l6 6-6 6"/>
              </svg>
            </div>

            {/* After */}
            <div className="p-8 md:p-10 bg-[#001a00]">
              <p className="text-[9px] tracking-[0.4em] uppercase font-bold text-emerald-400 mb-5">After</p>
              <p className="font-extrabold text-[80px] md:text-[100px] leading-none tracking-[-0.05em] text-emerald-400">B</p>
              <p className="font-bold text-2xl text-emerald-400/70 mt-1 mb-3">80%</p>
              <p className="text-[10px] tracking-[0.2em] uppercase text-neutral-600">GTmetrix performance score</p>
            </div>
          </div>
        </FadeUp>
      ...
      {/* ── Project Meta ────────────────────────────────────────────────── */}
      <section className="px-8 md:px-14 py-12 border-b border-neutral-900">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-0 md:divide-x divide-neutral-800">
          {[
            ...
            <FadeUp key={item.label} className="md:px-8 first:pl-0 last:pr-0">
              <p className="text-[9px] tracking-[0.35em] uppercase text-neutral-500 mb-1.5">{item.label}</p>
      ...
      {/* ── The Problem ─────────────────────────────────────────────────── */}
      <section className="px-8 md:px-14 py-20 md:py-28 border-b border-neutral-900">
        <div className="grid md:grid-cols-2 gap-14 md:gap-20 items-start max-w-6xl">
          <FadeUp>
            ...
            <h2 className="font-extrabold text-3xl md:text-4xl tracking-tight leading-tight uppercase mb-6">
              A Homepage That<br />
              <span className="text-neutral-500">Kept Visitors Waiting</span>
            </h2>
          ...
          <FadeUp delay={0.12}>
            <p className="text-[9px] tracking-[0.35em] uppercase text-neutral-500 mb-6">Initial GTmetrix Snapshot</p>
            <div className="space-y-6 bg-neutral-950 border border-neutral-800/60 p-6 md:p-8">
              {[
                ...
                <div key={item.label}>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-[10px] tracking-[0.2em] uppercase text-neutral-400 font-bold">{item.label}</span>
              ...
              <p className="text-[9px] tracking-[0.2em] uppercase text-neutral-700 pt-3 border-t border-neutral-800/60">
      ...
      <section className="px-8 md:px-14 py-20 md:py-28 border-b border-neutral-900">
        <div className="max-w-4xl">
          ...
          <FadeUp delay={0.08}>
            <p className="text-neutral-400 text-base leading-relaxed mb-5 max-w-2xl">
          ...
          <FadeUp delay={0.14} className="mt-10">
            <div className="grid md:grid-cols-3 gap-4">
              {[
                ...
                { label: "Duplicate resources",impact: "−1 pt",   color: "#6b7280" },
              ].map((item, i) => (
                <motion.div
                  key={item.label}
                  ...
                  className="flex items-center justify-between bg-neutral-950 border border-neutral-800/60 px-5 py-4"
                >
                  <span className="text-[11px] tracking-[0.1em] uppercase font-bold text-neutral-300">{item.label}</span>
      ...
      <section className="px-8 md:px-14 py-20 md:py-28 border-b border-neutral-900">
        <FadeUp className="mb-14">
          ...
          <h2 className="font-extrabold text-3xl md:text-4xl tracking-tight uppercase leading-tight">
            Five Targeted Fixes,<br />
            <span className="text-neutral-500">One Week</span>
          </h2>
          <p className="text-neutral-400 text-base leading-relaxed mt-5 max-w-2xl">
        ...
        <div className="grid md:grid-cols-2 gap-px bg-neutral-900">
          {FIXES.map((item, i) => (
            <FadeUp key={item.num} delay={i * 0.06} className="bg-[#030303] p-8 md:p-10 service-row-item relative group">
              ...
              <div className="flex items-start justify-between mb-5">
                ...
                <div className="flex flex-wrap gap-1.5 justify-end max-w-[60%]">
                  {item.tags.map((t) => (
                    <span key={t} className="text-[8px] tracking-widest font-bold uppercase px-2 py-1 border border-neutral-800 text-neutral-600">
                      {t}
                    </span>
                  ))}
                </div>
              </div>
              <h3 className="font-extrabold text-lg md:text-xl uppercase tracking-tight mb-3 leading-tight">
                {item.title}
              </h3>
      ...
      <section className="px-8 md:px-14 py-20 md:py-28 border-b border-neutral-900">
        <FadeUp className="mb-14">
          ...
          <h2 className="font-extrabold text-3xl md:text-4xl tracking-tight uppercase leading-tight">
            Seven Days,<br />
            <span className="text-neutral-500">Start to Finish</span>
          </h2>
        </FadeUp>

        <div className="relative max-w-2xl">
          {/* Vertical line — at dot center: span(52px) + gap-3(12px) + half-dot(5px) = 69px */}
          <div className="absolute left-[69px] top-0 bottom-0 w-px bg-neutral-800" />

          {TIMELINE.map((item, i) => (
            <FadeUp key={item.period} delay={i * 0.07}>
              <div className="flex items-start border-b border-neutral-900/50 last:border-0 py-8">

                {/* Period label + dot in same flex row — guarantees vertical alignment */}
                <div className="shrink-0 flex items-center gap-3 relative z-10">
                  ...
                  <div className="w-2.5 h-2.5 rounded-full border-2 border-[#ff6b3d] bg-[#030303] shrink-0" />
                </div>

                {/* Content */}
                <div className="flex-1 pl-6">
                  <h3 className="font-extrabold text-[13px] uppercase tracking-[0.06em] mb-2 leading-tight text-white">
                    {item.title}
                  </h3>
      ...
      <section className="px-8 md:px-14 py-20 md:py-28 border-b border-neutral-900">
        <FadeUp className="mb-14">
          ...
          <h2 className="font-extrabold text-3xl md:text-4xl tracking-tight uppercase leading-tight">
            ...
            <span className="text-neutral-500">And Feel</span>
          </h2>
        </FadeUp>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-14">
          {[
            ...
            <FadeUp key={s.label} delay={i * 0.08}>
              <div className="border border-neutral-800 p-7 flex flex-col gap-1.5">
                <p className="font-extrabold text-3xl md:text-4xl tracking-[-0.03em] text-white leading-none">{s.value}</p>
                <p className="text-[10px] tracking-[0.3em] uppercase font-bold text-neutral-400 mt-2">{s.label}</p>
                <p className="text-[9px] tracking-[0.2em] uppercase text-neutral-600">{s.sub}</p>
              </div>
            </FadeUp>
          ))}
        </div>
        ...
        <FadeUp delay={0.1} className="bg-neutral-950 border border-neutral-800/60 p-6 md:p-10 mb-10 max-w-2xl">
          <p className="text-[9px] tracking-[0.35em] uppercase text-neutral-500 mb-7">GTmetrix Score Comparison</p>
          <div className="space-y-6">
            <div>
              <div className="flex justify-between items-center mb-2">
                <span className="text-[10px] tracking-[0.2em] uppercase font-bold text-neutral-400">Before</span>
                <span className="font-extrabold text-sm text-red-400">Grade D — 60%</span>
              </div>
              <AnimBar pct={60} color="#ef4444" delay={0} />
            </div>
            <div>
              <div className="flex justify-between items-center mb-2">
                <span className="text-[10px] tracking-[0.2em] uppercase font-bold text-neutral-400">After</span>
        ...
        <FadeUp delay={0.15}>
          <div className="border-l-2 border-[#ff6b3d] pl-6 md:pl-8 py-2 max-w-2xl">
            <p className="font-extrabold text-base uppercase tracking-tight mb-2">
      ...
      {/* ── CTA ─────────────────────────────────────────────────────────── */}
      <section className="px-8 md:px-14 py-24 md:py-32 text-center">
        <FadeUp>
          <p className="text-[9px] tracking-[0.4em] uppercase font-bold text-[#ff6b3d] mb-6">
            Is your site slowing down your revenue?
          </p>
          <h2 className="font-extrabold text-4xl md:text-6xl tracking-[-0.03em] uppercase leading-tight mb-10">
            Let's Fix Your<br />
            <span className="text-neutral-500">Speed Score</span>
          </h2>
          <div className="flex flex-col md:flex-row items-center justify-center gap-4">
            <a
              href="/#talk"
              className="inline-block bg-[#ff6b3d] text-white font-bold text-[11px] tracking-[0.25em] uppercase px-10 py-4 hover:bg-white hover:text-black transition-all duration-300"
            >
              GET A FREE AUDIT
            </a>
            <Link
              href="/#projects"
              className="inline-block border border-neutral-700 text-neutral-400 font-bold text-[11px] tracking-[0.25em] uppercase px-10 py-4 hover:border-white hover:text-white transition-all duration-300"
            >
              VIEW ALL WORK
            </Link>
          </div>
      ...
      {/* ── Footer ──────────────────────────────────────────────────────── */}
      <footer className="px-8 md:px-14 py-8 border-t border-neutral-900 flex flex-col md:flex-row items-center justify-between gap-4">
        <p className="text-[10px] tracking-[0.3em] uppercase text-neutral-600">
          © 2024 ALTTRED NEXXUS
        </p>
        <Link href="/" className="text-[10px] tracking-[0.3em] uppercase text-neutral-600 hover:text-white transition-colors">
          Back to Home
        </Link>
      </footer>
