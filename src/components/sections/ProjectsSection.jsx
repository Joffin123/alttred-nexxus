      ...
      {!p.hideOverlay && (
        <>
          <div className="relative z-10 flex justify-between items-center p-5 md:p-6">
            <span className="text-[9px] tracking-widest font-sans font-bold uppercase bg-black/70 text-white border border-neutral-700/50 px-3.5 py-1.5 rounded-full backdrop-blur-md">
              {p.tags[0]}
            </span>
          ...
          <div className="relative z-10 p-5 md:p-8">
            <h3 className="font-sans font-semibold text-xl md:text-3xl text-white mb-2 tracking-tight uppercase">
              {p.title}
            </h3>
            ...
            {p.slug && (
              <span className="inline-flex items-center gap-1.5 mt-4 text-[9px] tracking-[0.2em] font-sans font-bold uppercase text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
